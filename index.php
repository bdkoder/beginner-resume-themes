   ...
   <section id="about">  
   	...
   	<div class="row section-intro">
   		<div class="col-twelve">
   			...
   			<!-- <div class="intro-info">
   				...
   				<img src="images/my pic.jpg" alt="Profile Picture">
   	...
   	<div class="row about-content about-int">
   		...
   		<div class="col-six tab-full">
   			...
   			<h3>Skills</h3>
   			<p>I came IT site in 2014. At first I Start With Programming and Now also working Web Application & As a Web Developer.
   			<br>
   			I am always trying to Discant something new and I Love all Creative thought. </p>
	...
	<section id="resume" class="grey-section">
		...
		<div class="row section-intro">
   		<div class="col-twelve">
   			...
   			<p class="lead">Here Under all of my Academic Experince and also with all of my Short Course Experince List. </p>
   		...
   		<div class="col-twelve">
	         ...
	         <div id="folio-wrapper" class="block-1-2 block-mob-full stack">
	         	...
	         	<div class="bgrid folio-item">
	               <div class="item-wrap">
	               	<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/liberty.jpg" alt="Liberty">
	            ...
	            <div class="bgrid folio-item">
	               <div class="item-wrap">
	               	<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/clouds.jpg"alt="Clouds">
	            ...
	            <div class="bgrid folio-item">
	               <div class="item-wrap">
	               	<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/beetle.jpg" alt="Beetle">
	        		...
	        		<div class="bgrid folio-item">
	               <div class="item-wrap">
	               	<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/lighthouse.jpg" alt="Lighthouse">
	            ...
	            <div id="modal-01" class="popup-modal slider mfp-hide">	
				     	...
				     	<div class="media">
				     		<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/modals/m-liberty.jpg" alt="" />
				     	</div>      	
				   ...
				   <div id="modal-03" class="popup-modal slider mfp-hide">	
				     	...
				     	<div class="media">
				     		<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/modals/m-clouds.jpg" alt="" />
				     	</div>      	
				   ...
				   <div id="modal-04" class="popup-modal slider mfp-hide">	
				     	...
				     	<div class="media">
				     		<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/modals/m-beetle.jpg" alt="" />
				     	</div>      	
				   ...
				   <div id="modal-05" class="popup-modal slider mfp-hide">	
				     	...
				     	<div class="media">
				     		<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/modals/m-lighthouse.jpg" alt="" />
				     	</div>      	
				   ...
				   <div id="modal-06" class="popup-modal slider mfp-hide">	
				     	...
				     	<div class="media">
				     		<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio/modals/m-salad.jpg" alt="" />
				     	</div>      	
